...
const AddEtp = ({ isOpen, onClose, handleCloseModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (emptyFields) {
      ...
      console.log("Form submitted:", EtpData, UserData);
    ...
    <div className="fixed inset-0 flex justify-center items-center h-screen px-10 font-poppins">
      <div className="border-2 border-black bg-white rounded-xl p-5">
        <div className="flex justify-between items-center border-b-[1px] border-[#99999] w-full pb-5">
          <h1 className="text-2xl font-semibold">Ajouter une entreprise</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-3 gap-5 mb-4">
              ...
              <div className="p-3 flex flex-col gap-2">
                ...
                <input type="text" className="border-2 border-[#99999] h-8 rounded-md py-2 px-2 outline-none" value={localisation} onChange={e => setLocalisation(e.target.value)} />
              </div>
            </div>
            {/* Footer */}
