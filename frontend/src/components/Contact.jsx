    ...
    return (
        <UserLayout>
            <div className="px-4 sm:px-10 mt-10">
                <h1 className="text-3xl sm:text-5xl h-1/6 mb-10 sm:mb-20 font-bold">Contactez-Nous</h1>
                <div className="w-full h-5/6 flex flex-col lg:flex-row items-start gap-14">
                    <div className="w-full lg:w-1/2 h-1/2 flex justify-center gap-5 items-center">
                        <div className="flex flex-col gap-5">
                            <h1 className="text-2xl sm:text-3xl font-semibold">Parlez avec nous</h1>
                            <p className="text-xl sm:text-2xl">Des questions, des commentaires ou des suggestions ? Remplissez simplement le formulaire et nous vous contacterons sous peu.</p>
                            <div className="flex flex-col gap-3">
                                <p className="font-normal flex gap-5 items-start">
                                    <IoLocation className="text-2xl sm:text-3xl" />
                                    <span className="text-lg sm:text-xl text-[#327AF8] font-medium w-[200px] sm:w-[332px]">1029 Route Bouskoura, km 9, 20190 Casablanca</span>
                                </p>
                                <p className="font-normal flex gap-5 items-center">
                                    <FaPhone className="text-2xl sm:text-3xl" />
                                    <span className="text-lg sm:text-xl text-[#327AF8] font-medium">(+212) 622 222 222</span>
                                </p>
                                <p className="font-normal flex gap-5 items-center">
                                    <IoMail className="text-2xl sm:text-3xl" />
                                    <span className="text-lg sm:text-xl text-[#327AF8] font-medium">ofppt.estage@gmail.com</span>
                                </p>
                            </div>
                        </div>
                    </div>
